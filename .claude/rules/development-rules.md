...
- **[IMPORTANT]** For web framework projects (Next.js, Nuxt, SvelteKit, Astro, etc.), also follow `./.claude/rules/frontend-standards.md` — every project MUST have full SEO metadata (metadataBase, openGraph, twitter), OG image, `generateMetadata` on dynamic routes, robots/sitemap. Applies to scaffolding AND to any page edits.
