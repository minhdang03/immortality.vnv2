---
title: "Battudao Mobile App — Bootstrap (DEPRECATED)"
description: "DEPRECATED 2026-05-10 — Discord-style chat MVP wrong for Bất Tử Đạo (anti-spiritual, FOMO triggers). Replaced by 260510-2129-bat-tu-dao-mobile-hybrid (RN hybrid, anti-tier, anti-Buddhist). See plans/reports/bootstrap-prompt-260510-2122-*.md."
status: deprecated
deprecatedOn: 2026-05-10
deprecatedReason: "Discord-style chat conflicts with Bất Tử Đạo philosophy (no FOMO, anti-hierarchy). Architecture pivot to hybrid RN + CF Workers backend."
replacedBy: 260510-2129-bat-tu-dao-mobile-hybrid
priority: P2
effort: 13d
branch: main
tags: [expo, react-native, firebase, webrtc, livestream, chat, battudao, deprecated]
created: 2026-05-02
---
