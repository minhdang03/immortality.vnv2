...
| 05 | [Captcha Turnstile end-to-end](phase-05-turnstile-captcha.md) | C-04 | B | **Fable** | 1 ngày | ✅ 18/07 21:50 — code+verify xong, captcha giữ TẮT tới trước public link (`1a67375`) |
| 06 | [Nội quy cộng đồng + link đăng ký + funnel events](phase-06-community-guidelines-funnel.md) | D-05, A-05(code), B-02(call-site) | B | Opus (fast) | 0.5 ngày | 🔨 19/07 — màn Nội quy + 2 lối vào + funnel auth/QA xong, build xanh, 4/4 test. CÒN: funnel `first_message` trong `ConversationStore` (phiên khác đang giữ file) |
