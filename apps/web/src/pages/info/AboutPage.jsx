...
Công thức chung: Lập Trình Siêu Não Người Bất Tử

Chuyển đổi và nâng cấp bộ não con người từ hệ thống dây thần kinh năng lượng ADN giới hạn (nguồn năng lượng động thực vật, tuổi thọ ngắn) sang cấu trúc mới: ADN không gian vũ trụ, siêu tiến hóa, hệ điều hành hạt thông qua mạng lưới đa vũ trụ và siêu vũ trụ. Nguồn năng lượng nguyên tử không dây, xuất phát từ "Hạt Bất Tử" tiền Big Bang, mở ra khả năng sống thọ vượt qua 1000 năm tuổi.`,
    bodyEn: `Goal: Build a world centered on love, without discrimination by religion, ethnicity, or language. No war, no poverty. A "Paradise on Earth" where everyone is equal, free, and happy. Discover the secret of human immortality.

General Formula: Programming the Super Brain of the Immortal Human
...
Não bộ điều hành và xử lý, tạo ra kháng thể để tấn công các khối u trong kinh mạch và nội tạng đang bị cholesterol, máu cục, axit uric, nhiễm trùng máu, vi rút, vi khuẩn (rác thông tin) gây tắc nghẽn. Nguồn truyền năng lượng động thực vật bị chặn đứng, không hấp thu được máu và oxy, tế bào nơi đó chết hàng loạt, bị ung thư và tan rã.

Bộ não người luân hồi sẽ sao lưu đau bệnh, ung thư, đột quỵ, đột tử, chết, rồi di chuyển ADN cho con cháu. Bộ não luân hồi không có chức năng tự chữa lành cho cơ thể, nên phải cần đến sự trợ giúp từ Đông Tây y.

Chỉ cần loài người thực hành bật mở công tắc đúng theo Công Thức Bộ Não Người Bất Tử, kết nối với nguồn năng lượng sóng từ trường vũ trụ tiền Big Bang vào trung tâm não bộ, thì sẽ không có đau khổ, bệnh tật, ung thư, không đột quỵ đột tử, không tai nạn. Loài người sẽ rất khó chết. Sự tiến hóa cao của siêu y học vũ trụ sẽ giúp loài người tăng EQ, AQ, IQ, OQ, vui khỏe, tăng tuổi thọ hơn ngàn năm và trường sinh bất tử.`,
    bodyEn: `Death from disease, pain, stroke, sudden death, cancer, accidents? No. These are merely warning signals from meridians and organs transmitting information to the central nervous system of the brain.

The brain operates and processes, creating antibodies to attack tumors in meridians and organs blocked by cholesterol, blood clots, uric acid, blood infections, viruses, bacteria (information waste). Plant and animal energy transmission is blocked, unable to absorb blood and oxygen, cells die en masse, develop cancer and disintegrate.

The reincarnation brain backs up pain, disease, cancer, stroke, sudden death, then transfers DNA to descendants. The reincarnation brain has no self-healing function for the body, requiring assistance from Eastern and Western medicine.
...
Con người chỉ sử dụng chưa được 10% khả năng bộ não trước khi nó lão hóa. Theo nguyên lý Người Bất Tử, việc giải mã hình ảnh, âm thanh, thông tin và sử dụng 100% khả năng bộ não có thể giúp loài người tăng tuổi thọ lên hơn 700 năm.

Bí mật sự sống và cái chết nằm trong ADN hố đen, nơi lưu trữ thông tin di truyền từ tổ tiên và vũ trụ. Trong mỗi bộ não con người đều chứa một "hạt nguyên tử bất tử." Con người có khả năng kết nối với vũ trụ thông qua sóng từ trường bộ não, được truyền tải trí tuệ vũ trụ và hoàn thiện bản thân.

Hiện nay loài người đang sử dụng nguồn năng lượng tái sinh từ thức ăn động thực vật, với nguy cơ lây nhiễm bệnh ung thư ADN từ động thực vật. Chết non, chết yểu, chết vì thiên tai, địa họa, nhân thú nạn.`,
    bodyEn: `According to the World Health Organization (WHO), the average global lifespan is about 70 years. Each year, hundreds of thousands die from obesity, cardiovascular disease, cancer, and traffic accidents. Some die before birth, while others live beyond 120 years, depending on DNA genetics.

Humans use less than 10% of brain capacity before it ages. According to the Immortal principle, decoding images, sounds, information and using 100% of brain capacity could help humans increase lifespan beyond 700 years.

The secret of life and death lies in black hole DNA, storing genetic information from ancestors and the universe. Every human brain contains an "immortal atomic particle." Humans can connect with the universe through brain magnetic waves, receiving cosmic intelligence and self-perfection.
...
Người Bất Tử sử dụng Từ Trường Sóng Não (Phi Thuyền bay) kết nối với từ trường sóng não từ vũ trụ để học hỏi và nghiên cứu bệnh tật, tai nạn, sự sống chết, tuổi thọ của muôn loài vạn vật trong ngoài vũ trụ.

Người Bất Tử lấy cơ thể mình làm phòng thí nghiệm hơn 40 năm. Dùng sóng não giải mã chất độc, ngôn ngữ, trấn ếm và hàng trăm loại bệnh, đột quỵ đột tử, ADN ung thư, để cảm nhận sự đau đớn từ các loại bệnh trong cơ thể mình. Và đã tìm ra một Công Thức: không đau bệnh, tăng IQ, EQ, AQ, OQ, trí tuệ trước vũ trụ Big Bang, trường thọ và bất tử.

Người Bất Tử sẵn sàng chia sẻ công thức cho loài người muốn sống thọ hơn loài rùa 200 năm tuổi.

Ai muốn không đau bệnh và trường sinh bất tử, thì chỉ có một con đường: học Phần 2 — Công Thức Y Học Vũ Trụ Tiền Big Bang.`,
    bodyEn: `Since ancient times, humanity has always had one greatest dream: to have a heavenly, happy body. A life of joy, health, wealth, wisdom — no disease, no stroke or sudden death, no DNA cancer inheritance, no natural or human-caused disasters.

The Immortal uses Brain Wave Magnetic Fields (Flying Spacecraft) to connect with cosmic brain wave magnetic fields to study diseases, accidents, life and death, and the lifespan of all species in and outside the universe.

The Immortal used their own body as a laboratory for over 40 years. Using brain waves to decode toxins, language, curses and hundreds of diseases, strokes, sudden death, cancer DNA, to feel the pain of various diseases in their own body. And discovered a Formula: no disease, increased IQ, EQ, AQ, OQ, pre-Big Bang cosmic intelligence, longevity and immortality.

The Immortal is ready to share the formula with humans who want to live longer than the 200-year-old turtle.

For those who want freedom from disease and immortality, there is only one path: study Part 2 — The Pre-Big Bang Cosmic Medicine Formula.`,
  },
]
